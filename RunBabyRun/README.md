...
Hráč 1 otevře **Kampaň ve dvou**, pošle odkaz nebo ukáže QR kód. Na mobilu tlačítko **Poslat pozvánku** otevře systémové sdílení, kde lze vybrat WhatsApp; krátké přepnutí do jiné aplikace pozvánku neruší. Hráč 2 odkaz jen otevře; hráč 1 spustí společný odpočet. Oba mohou používat klávesnici nebo dotykové tlačítko. Hráč 1 spouští i každou další zónu, hráč 2 nic nepotvrzuje. Při skrytí stránky se hra pozastaví, při odpojení je nutná nová dvojice. Sólo rekordy se nemění.
